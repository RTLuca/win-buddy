...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::focus_complete_with_break,
            commands::focus_complete_without_break,
            ...
            commands::overlay_drag_start,
            commands::overlay_position_reset,
            commands::overlay_position_nudge,
